    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            switch (command) {
                ...
                case 0: //show all notes

                    ArrayList<String> notes = SQLiteClass.getAllNotes();

                    JSONObject jsonToReturn0 = new JSONObject();
                    jsonToReturn0.put("answer", "notes");
                    jsonToReturn0.put("list", notes.toString());
                ...
                case 1: //add new note
                    ...
                    String data = jsonObject.getString("note");

                    SQLiteClass.addNote(data);
